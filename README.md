---
自6.0起，请不要克隆和下载仓库，仓库涵盖8种辅助码，除非你直到自己在做什么。我在release做了分包处理，你可以在最新的版本号下载到正式的方案库，可以在每夜词库更新获得最新的词库和模型更新，小幅度微调我也会直接在最新的release update
区别是辅助码无需配置了而是通过选择下载来确认词库携带的辅助码，体积更小！
---
...
再次打开```wanxiang_radical.schema.yaml```和``` wanxiang_en.schema.yaml```表头进行选择，二者情况一致：
